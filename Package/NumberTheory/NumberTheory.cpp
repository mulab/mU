...
void Initialize()
{
	...
	DECL_TAG_SYM_WRAPPED_CPROC(FactorInteger)
	DECL_TAG_SYM_WRAPPED_CPROC(SeedRandom)
	DECL_TAG_SYM_WRAPPED_CPROC(RandomInteger)
	DECL_TAG_SYM_WRAPPED_CPROC(RandomPrime)
	DECL_TAG_SYM_WRAPPED_CPROC(NextPrime)
	DECL_TAG_SYM_WRAPPED_CPROC(IntegerLength)
	DECL_TAG_SYM_WRAPPED_CPROC(GCD)
	DECL_TAG_SYM_WRAPPED_CPROC(LCM)
	DECL_TAG_SYM_WRAPPED_CPROC(ExtendedGCD)
	DECL_TAG_SYM_WRAPPED_CPROC(ChineseRemainder)
	DECL_TAG_SYM_WRAPPED_CPROC(PrimeQ)
